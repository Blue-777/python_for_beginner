...
def loadImage(fname) :  # raw --> DB
    ...
    con = sqlite3.connect("C:\Users\Donge\Downloads\CookPython\\rawDB")  # DB가 저장된 폴더까지 지정
    cur = con.cursor()
    fp = open(fname, 'rb')
...
if __name__ == "__main__" :
    ...
    # 테이블 초기화
    con = sqlite3.connect("C:\Users\Donge\Downloads\CookPython\\rawDB")  # 소스코드가 저장된 폴더에 생성됨
    cur = con.cursor()
    ...
    filename = 'C:\Users\Donge\Downloads\CookPython\RAW'  # C:/CookPython/RAW/tree.raw
