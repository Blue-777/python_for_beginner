...
# btnPrev2 = Button(window, text = "page down", command = clickPrev)
# btnNext2 = Button(window, text = "page up", command = clickNext)

# photo = PhotoImage(file = "gif/" + fnameList[0])
# pLabel = Label(window, image = photo)

# btnPrev.place(x = 250, y = 5)
# btnNext.place(x = 400, y = 5)
# btnPrev2.place(x = 225, y = 35)
# btnNext2.place(x = 400, y = 35)
# pLabel.place(x = 15, y = 70)
